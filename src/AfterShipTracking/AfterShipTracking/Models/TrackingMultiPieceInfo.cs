...
namespace AfterShipTracking
{
    ...
    /// </summary>
    public class TrackingMultiPieceInfo
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("type")]
        public TrackingMultiPieceInfoType? Type { get; set; }
        /// <summary>
        ///  Pieces List of all pieces in the MPS, including the master and all child pieces.
        /// </summary>
        [JsonProperty("pieces")]
        public TrackingMultiPieceInfoPieces[]? Pieces { get; set; }
        public TrackingMultiPieceInfo()
        {
        }
    }
}
